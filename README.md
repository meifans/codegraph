...
### Supercharge Claude Code, Cursor, Codex, OpenCode, and Antigravity with Semantic Code Intelligence
...
<sub>Interactive installer auto-configures your agent(s) — Claude Code, Cursor, Codex CLI, opencode, antigravity</sub>
...
The installer will:
- Ask which agent(s) to configure — auto-detects installed ones from: **Claude Code**, **Cursor**, **Codex CLI**, **opencode**, **antigravity**
...
Restart your agent (Claude Code / Cursor / Codex CLI / opencode / antigravity) for the MCP server to load.
...
**Made for AI coding agents — Claude Code, Cursor, Codex CLI, opencode, and antigravity**
